        ...
        <div class="row">
            <div class="col-md">
                ...
                <?php 
                    ...
                    $listadoEventos = new administracionView();
                    $listadoEventos->listarEventos();
            ...
            <div class="col-md">
                ...
                <form method="POST" action="eventos.php">
                    <div class="input-group mb-3">
                        ...
                        <input type="text" name="tituloEvento" class="form-control" placeholder="Titulo del Evento" aria-label="Username" aria-describedby="basic-addon1" required name="titulo">
                    </div>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <textarea type="text" name="detalleEvento" class="form-control" placeholder="Detalles del Evento" aria-label="Username" aria-describedby="basic-addon1" required name="detalles">
                        </textarea>
                    </div>


                    <input type="submit" name="ingresar" value="Publicar" class="btn btn-success">
                    <?php 
                        if(isset($_POST['ingresar'])){
                            $eventos = new administracionView();
