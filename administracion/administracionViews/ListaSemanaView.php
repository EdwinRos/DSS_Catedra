...
class ListaSemanaView extends AdministracionModel
{
    ...
    public function cargarCanciones()
    {
        ...
        for ($i =2 ; $i < count($results) ; $i++) {
            echo "<li class='list-group-item'> $results[$i] <button href='administr' class='btn btn-danger float-end'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-trash3' viewBox='0 0 16 16'>
