...
<body>
  ...
  <br><br>
  <br>
  <h1 class="container-fluid">Canciones de la semana</h1><br>
  <br>
  <div class="container w-75">
    ...
    <table class="table table-striped" id="listaSemana">
      ...
      <tbody>
        <?php
        $position = 0;
        $files = scandir("../upploads/Lista/listaSemana");
        if (count($files) > 2) {
  ...
  <<!-- Footer -->
    ...
    <script>
      ...
      for (let i = 1; i < table.rows.length; i++) {
        canciones.push(
          "../upploads/Lista/listaSemana/" + table.rows[i].cells[1].innerHTML
        )
      }
      let cancion;
      let timer = 0;
